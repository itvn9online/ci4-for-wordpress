...
function remove_period__price(i) {
    ...
    if (checkout_config.period_price[i].toString() != '0' || checkout_config.period_discount[i].toString() != '0' || checkout_config.period_bonus[i].toString() != '0') {
    ...
    checkout_config.period_price = $.grep(checkout_config.period_price, n => n == 0 || n);
    checkout_config.period_discount = $.grep(checkout_config.period_discount, n => n == 0 || n);
    checkout_config.period_bonus = $.grep(checkout_config.period_bonus, n => n == 0 || n);
    console.log(checkout_config);
...
function before_period_price_html() {
    create_period_price_html(checkout_config.period_price, checkout_config.period_discount, checkout_config.period_bonus);
}
...
function change_period__value(k, i, v) {
    ...
    //
    $('#data_' + k).val(checkout_config[k].join(';')).trigger('change');
}
