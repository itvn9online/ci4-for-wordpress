...
if ($getconfig->g_firebase_config != '') {
    ...
    if ($firebase_language_code != '') {
        $firebase_language_code = '__' . $firebase_language_code;
    }
...
?>
    ...
    <script src="https://www.gstatic.com/firebasejs/ui/6.0.2/firebase-ui-auth<?php echo $firebase_language_code; ?>.js"></script>
