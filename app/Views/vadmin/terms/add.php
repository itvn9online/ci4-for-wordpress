    ...
    <div class="widget-content nopadding">
        <form action="" method="post" name="admin_global_form" id="admin_global_form" accept-charset="utf-8" class="form-horizontal" target="target_eb_iframe">
            ...
            <div class="form-actions frm-fixed-btn cf">
                ...
                if ($data['term_id'] > 0) {
                ?>
                    <a href="sadmin/<?php echo $controller_slug; ?>/delete?id=<?php echo $data['term_id']; ?>" onClick="return click_a_delete_record();" class="btn btn-danger btn-small" target="target_eb_iframe"><i class="fa fa-trash"></i> XÓA
                        <?php echo $name_type; ?>
                    </a>
