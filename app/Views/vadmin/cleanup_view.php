...
<div class="left-menu-space">
    <div class="row">
        <div class="col">
            <div>
                <form action="sadmin/dashboard/cleanup_matching_cache" method="post" role="form" onsubmit="return waiting_cleanup_cache();" enctype="multipart/form-data" target="target_eb_iframe">
        ...
        <div class="col">
            <div>
                <form action="sadmin/dashboard/reset_term_permalink" method="post" role="form" onsubmit="return waiting_cleanup_cache();" enctype="multipart/form-data" target="target_eb_iframe">
                    <br>
                    <div>
            ...
            <br>
            <div>
                <form action="sadmin/dashboard/reset_post_permalink" method="post" role="form" onsubmit="return waiting_cleanup_cache();" enctype="multipart/form-data" target="target_eb_iframe">
                    <br>
                    <div>
