    ...
    <div class="row">
        <div class="col">
            <div v-if="post_status == PostType_DELETED">
                ...
                <button type="button" onClick="return click_remove_checked('posts');" class="btn btn-danger"><i class="fa fa-remove"></i> XÓA <span v-if="ALLOW_USING_MYSQL_DELETE == true">Hoàn toàn</span></button>
            </div>
            <div v-if="post_status != PostType_DELETED">
