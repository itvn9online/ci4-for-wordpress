...
<div id="app" class="widget-box">
    <div class="widget-content nopadding">
        <form action="" method="post" name="admin_global_form" id="admin_global_form" accept-charset="utf-8"
            onSubmit="return before_submit_user_add();" class="form-horizontal" target="target_eb_iframe">
                ...
                <div class="col col-8 left-user-add">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls bold"><a
                                href="admin/<?php echo $controller_slug; ?>/login_as?id=<?php echo $data['ID']; ?>"
                                class="btn btn-info admin-login-as" target="target_eb_iframe">Đăng nhập với tư cách
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="email" class="span6" placeholder="Email" name="data[user_email]"
                                id="data_user_email" value="<?php echo $data['user_email']; ?>" aria-required="true"
                                required />
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" class="span6" placeholder="Họ và tên" name="data[display_name]"
                                id="data_display_name" value="<?php echo $data['display_name']; ?>" />
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">Tên rút gọn</label>
                        <div class="controls">
                            <input type="text" class="span4" placeholder="Tên rút gọn" name="data[user_nicename]"
                                value="<?php echo $data['user_nicename']; ?>" />
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">Ngày sinh</label>
                        <div class="controls">
                            <input type="date" class="span4" placeholder="Ngày sinh" name="data[user_birthday]"
                                value="<?php echo $data['user_birthday']; ?>" />
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">Website/ Facebook</label>
                        <div class="controls">
                            <input type="text" class="span6" placeholder="Website/ Trang cá nhân" name="data[user_url]"
                                id="data_user_url" value="<?php echo $data['user_url']; ?>" />
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" class="span4" placeholder="Mật khẩu" name="data[ci_pass]"
                                id="data_ci_pass" value="<?php echo $data['ci_pass']; ?>" />
                        </div>
                    </div>
                    <?php
                    } else {
                    ...
                    <br>
                    <div class="control-group">
                        <label class="control-label"><span class="hide-if-change-password">&nbsp;</span> <span
                                class="show-if-change-password d-none">Thay đổi mật khẩu</span></label>
                        <div class="controls">
                            ...
                            <div class="show-if-change-password d-none">
                                <input type="text" class="span4" placeholder="Mật khẩu" name="data[ci_pass]"
                                    id="data_ci_pass" value="<?php echo $data['ci_pass']; ?>" />
                                <button type="button" onClick="return random_input_change_user_password();"
                                    class="btn btn-info"><i class="fa fa-refresh"></i> Tạo mật khẩu ngẫu nhiên</button>
                                <button type="button" onClick="return submit_input_change_user_password();"
                                    class="btn btn-primary"><i class="fa fa-save"></i> Cập nhật</button>
                                <button type="button" onClick="return close_input_change_user_password();"
                                    class="btn btn-danger"><i class="fa fa-backward"></i> Hủy bỏ</button>
