    ...
    <table class="table table-bordered table-striped with-check table-list eb-table">
        ...
        <tbody id="admin_main_list">
            <tr data-id="{{v.term_id}}" class="each-to-child-term">
                ...
                <td>{{v.term_id}}</td>
                <td><span data-id="{{v.parent}}"
                          data-taxonomy="<?php echo $taxonomy; ?>"
                          data-line="{{v.gach_ngang}}"
                          class="parent-term-name"></span> <a href="{{v.get_admin_permalink}}">{{v.gach_ngang}}{{v.name}} <i class="fa fa-edit"></i></a></td>
        ...
        <form name="frm_admin_search_controller" action="./admin/<?php echo $controller_slug; ?>/multi_add" method="post" target="target_eb_iframe">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="termMultiAddModalLabel">Thêm nhanh <?php echo $name_type; ?></h5>
                ...
                <div class="modal-body">
                    ...
                    <p><?php echo $name_type; ?> cha: <strong id="multi_add_parent_name"></strong></p>
                    <div class="form-group">
                        <label><strong>Nhập danh sách <?php echo $name_type; ?> cần thêm:</strong>
                            <textarea name="data[term_name]" id="data_term_name" rows="10" class="d-block form-control" aria-required="true" required></textarea>
                        </label>
                        <p class="description">Có thể nhập nhiều <?php echo $name_type; ?>, mỗi <?php echo $name_type; ?> cách nhau bởi dấu xuống dòng [Enter].</p>
                    </div>
                </div>
