    ...
    <div class="row">
        <div class="col">
            <div v-if="by_is_deleted == DeletedStatus_DELETED">
                ...
                <button type="button" onClick="return click_remove_checked('terms');" class="btn btn-danger"><i class="fa fa-remove"></i> XÓA <span v-if="ALLOW_USING_MYSQL_DELETE == true">Hoàn toàn</span></button>
            </div>
            <div v-if="by_is_deleted != DeletedStatus_DELETED">
