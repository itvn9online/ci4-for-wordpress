        ...
        <div class="col-main-content custom-width-page-main fullsize-if-mobile">
            <div class="col-main-padding col-page-padding">
                <h1 data-type="<?php echo $data['post_type']; ?>" data-id="<?php echo $data['ID']; ?>"
                    class="blog-details-title global-details-title global-module-title">
                    <?php
                    echo $data['post_title'];
                    ?>
                </h1>
                <div
                    class="img-max-width medium l20 global-details-content <?php echo $data['post_type']; ?>-details-content ul-default-style remove-first-img">
                    <?php
                ...
                <br>
                <ul id="blog_same_cat"
                    class="fix-li-wit eb-blog other-eb-blog cf <?php $option_model->blogs_in_line($getconfig); ?>">
                    <?php
