            ...
            <div class="s14 main-profile">
                <div id="data-user_email">
                    ...
                    <div class="row changed-user_email d-none">
                        <div class="col small-12 medium-4 large-4 l40">Email (required)</div>
                        <div class="col small-12 medium-8 large-8">
                            ...
                            <div class="top-menu-space10">
                                ...
                                ?>
                                    When you change your email, we will send a confirmation email to the old email address.
                                    <strong>The new email will not be activated until you confirm the change</strong>
                                <?php
                                } else {
                                ?>
                                    The current email is an automatic email generated by the system and cannot be used.
                                    Please change to your own email (if available)
                                <?php
                                }
                                ?>
                                - <em class="cur bluecolor cancel-change-email">Cancel <i class="fa fa-remove"></i></em>
                            </div>
                        </div>
                    </div>
                </div>
