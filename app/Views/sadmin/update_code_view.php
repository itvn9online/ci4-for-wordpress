...
<div class="cf">
    <div class="lf f45">
        ...
        <form method="post" action="./sadmin/dashboard/download_code" onsubmit="return before_start_download_in_github();" target="target_eb_iframe">
    ...
    <div class="lf f55">
        ...
        <form method="post" action="./sadmin/dashboard/reset_code" onsubmit="return before_start_reset_in_github();" target="target_eb_iframe">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="sadmin/dashboard/restore_code" class="d-inline" target="target_eb_iframe">
    ...
    <div class="modal fade" id="cleanupModal" tabindex="-1" aria-labelledby="cleanupModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    <a href="sadmin/dashboard/cleanup_code" class="d-inline" target="target_eb_iframe">
...
?>
    ...
    <div>
        <form action="./sadmin/dashboard/unzip_lai_themename" method="post" target="target_eb_iframe">
            <input type="hidden" name="data" value="1" />
            <div>
...
<div>
    <form action="./sadmin/dashboard/unzip_thirdparty" method="post" onSubmit="return before_unzip_thirdparty();" target="target_eb_iframe">
        <input type="hidden" name="data" value="1" />
        <div>
