...
class ConfigType
{
    ...
    public static function meta_desc($key)
    {
        ...
        $arr = [
            ...
            'zns_phone_for_test' => 'Số điện thoại dùng để test chức năng gửi tin nhắn qua Zalo ZNS. <br> * Gửi thử tin nhắn OTP qua ZNS tại đây: ' . base_url('admin/zalooas/send_test_otp_zns') . ' <br> * Gửi thử tin nhắn thông báo qua Zalo OA tại đây: ' . base_url('admin/zalooas/send_test_msg_oa'),
