...
class ConfigType
{
    ...
    public static function meta_default($config_type)
    {
        if ($config_type == self::CONFIG) {
            ...
            $arr = [
                ...
                'auto_logout_firebase' => 'Xóa phiên Firebase sau mỗi lần kết nối',
    ...
    public static function meta_type($key)
    {
        $arr = [
            ...
            'reverify_firebase_email' => 'checkbox',
            'auto_logout_firebase' => 'checkbox',
    ...
    public static function meta_desc($key)
    {
        ...
        $arr = [
            ...
            'auto_logout_firebase' => 'Mặc định khi đăng nhập qua Firebase, kết nối của người dùng được giữ lại, nếu muốn người dùng phải thao tác kết nối mỗi khi đăng nhập, hãy kích hoạt chức năng này * Chức năng này cũng tăng độ bảo mật cho người dùng.',
