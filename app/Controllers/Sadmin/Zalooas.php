    ...
    public function send_test_otp_zns()
    {
        if (empty($this->zalooa_config->zns_phone_for_test)) {
            $this->result_json_type([
                ...
                'url' => base_url('sadmin/zalooas') . '?support_tab=data_zns_phone_for_test',
            ]);
        }
        ...
        $this->result_json_type([
            ...
            'result' => $this->zaloa_model->sendOtpZns($this->zalooa_config->zns_phone_for_test, mt_rand(1000, 9999), [
                //'mode' => 'development',
            ]),
        ]);
    }
    ...
    */
    ...
    public function refresh_access_token()
    {
        ...
        if ($result !== false && isset($result->access_token)) {
            $this->MY_redirect(base_url('sadmin/zalooas') . '?support_tab=data_zns_phone_for_test');
        }
