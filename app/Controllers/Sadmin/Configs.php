        ...
        $data_send = [
            ...
            */
            ...
            'message' => implode(
                '<br>',
                [
                    'PHPMailer version: ' . (is_file(APPPATH . 'ThirdParty/PHPMailer-6.10.0/VERSION') ? file_get_contents(APPPATH . 'ThirdParty/PHPMailer-6.10.0/VERSION', 1) : file_get_contents(APPPATH . 'ThirdParty/PHPMailer/VERSION', 1)),
